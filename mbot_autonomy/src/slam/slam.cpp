...
void OccupancyGridSLAM::initializePosesIfNeeded(void)
{
    ...
    // printf("have initialized %d \n", haveInitializedPoses_);
...
{   
    ...
    if(haveMap_ && (mode_ != mapping_only))
    {
        ...
        // std::cout << "current pose: x=" << currentPose_.x << " y=" << currentPose_.y << " theta=" << currentPose_.theta << std::endl;
...
void OccupancyGridSLAM::updateMap(void)
{
    ...
    if(mapUpdateCount_ % 5 == 0)
    {
        ...
        // printf("publishing to slam map channel, \n");
